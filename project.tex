...
\end{itemize}
\newpage
\section*{Time Taken for to verify known ramsey numbers}
\begin{table}[hbt!]
	\centering
	\begin{adjustbox}{max width=\textwidth}
		\begin{tabular}{| r | c |}
			...
			\midrule
			\textbf{R(2,2) = 2} & 0.0002942 \\
			\hline
			\textbf{R(2,3) = 3} & 0.0009021759 \\
			\hline
			\textbf{R(2,4) = 4} & 0.008728 \\
			\hline
			\textbf{R(2,5) = 5} & 0.1223 \\
			\hline
			\textbf{R(2,6) = 6} & 2.7557759 \\
			\hline
			\textbf{R(2,7) = 7} & 172.1652746 \\
			\hline
			\textbf{R(2,8) = 8} & 43956.63028907776 \\
			\hline
			\textbf{R(2,9) = 9} & \\
			\hline
			\textbf{R(2,10) = 10} & \\
			\hline
			\textbf{R(3,3) = 6} & 8.6705279 \\
			\hline
			\textbf{R(3,4) = 9} & \\
			\hline
			\textbf{R(3,5) = 14} & \\
