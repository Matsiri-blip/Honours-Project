...
\begin{enumerate}
	\item \includepdf[pages={4,3,2,1}]{Doc_20250302_185443.pdf}\newpage
...
\includepdf[pages={1,2}]{Doc_20250307_180116.pdf}
\includepdf[pages={1,2}]{Doc_20250309_183606.pdf}
\includepdf[pages={4,3,2,1}]{Doc_20250302_185443(1).pdf}
\end{document}